...
// YourWorld.Config = function(container) {
    ...
    var restrictDistance= 0; //0 means no restrictions
...
YourWorld.World = function() {
    ...
    function CoordMapTypeZoomedOut(tileSize) { 
        this.tileSize = tileSize; 
    }
...
function handleNoGeolocation(errorFlag) {
  ...
  map.setCenter(options.position);
	...
	CoordMapTypeZoomedOut.prototype.releaseTile = function(tile) {
		$(tile).remove();
		// console.log('REMOVING TILEssss');
	};
